...
export function PayOnRainApp() {
  ...
  const handleCheckWeather = () => {
    ...
    const randomRainfall = Math.random() * 100;
    const thresholdValue = parseFloat(policyData.threshold);
    const triggered = randomRainfall >= thresholdValue;

    setWeatherData({
      location: policyData.city,
      rainfall: parseFloat(randomRainfall.toFixed(1)),
      threshold: thresholdValue,
      condition: triggered ? "Heavy Rain" : "Light Rain",
      temperature: "18°C",
      triggered,
    });
          ...
          >
            <CardContent className="p-8">
              ...
              <div className="space-y-5">
                ...
                >
                  {policyCreated ? "✓ Policy Created" : "Create Policy"}
                </Button>
          ...
          >
            <CardContent className="p-8">
              ...
              <Button
                ...
                className="w-full bg-gradient-to-r from-[#0EA5E9] to-[#38bdf8] hover:from-[#0284c7] hover:to-[#0EA5E9] text-white font-bold text-[14px] px-6 py-4 rounded-[10px] h-auto transition-all hover:shadow-lg hover:shadow-[#0EA5E9]/30 active:scale-[0.98] mb-5"
              >
                Check Weather Now
              </Button>
                ...
                <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
                  ...
                  {weatherData?.triggered && !payoutConfirmed && (
                    <Button
                      ...
                      className="w-full bg-gradient-to-r from-[#7dd3fc] to-[#0EA5E9] hover:from-[#38bdf8] hover:to-[#0284c7] text-white font-bold text-[14px] px-6 py-4 rounded-[10px] h-auto transition-all hover:shadow-lg hover:shadow-[#7dd3fc]/30 active:scale-[0.98] animate-pulse"
                    >
                      💰 Process Payout Now
                    </Button>
                  )}
